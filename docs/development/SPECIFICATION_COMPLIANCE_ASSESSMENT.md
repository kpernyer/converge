...
- `docs/governance/DESIGN_TENETS.md` ✅ (exists)
- `ARCHITECTURE.md` → Should point to `docs/architecture/ARCHITECTURE.md`
- `TECHNOLOGY_STACK.md` → Should point to `docs/deployment/TECHNOLOGY_STACK.md`
...
The guide correctly:
- References required documents (ARCHITECTURE.md, docs/01-core-philosophy/DESIGN_TENETS.md, etc.)
...
1. **README.md Links**
   ...
   - **Reality:** These are in `docs/architecture/`
...
2. **Fix README.md Links**
   - Point to `docs/architecture/ARCHITECTURE.md`
   - Point to `docs/deployment/TECHNOLOGY_STACK.md`
...
5. **Update CONTRIBUTING.md Links**
